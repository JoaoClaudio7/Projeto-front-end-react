    ...
    return(
        <div className="w-full max-w-[440px] space-y-5">
                ...
                <div className="space-t-4">
                    ...
                    <div className="relative rounded-xl bg-gray-700 p-6 flex flex-col justify-center gap-3">
                        <span className="text-sm text-gray-300 leading-none">
                        <span className="font-semibold">1°</span> | Jordan Poole</span>
                        <span className="font-heading text-2xl font-semibold text-gray-200 leading-none ">1820</span>
                        <Image className="absolute top-0 right-8" src={medalSilver} alt={""}/>
                    </div>
                    <div className="relative rounded-xl bg-gray-700 p-6 flex flex-col justify-center gap-3">
                        <span className="text-sm text-gray-300 leading-none">
                        <span className="font-semibold">1°</span> | Anthony Jordan</span>
